...
public class Scene_Manager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject.Find("SpellBook").transform.localScale = new Vector3(Screen.width / 1536f * 1.6f * unityScaleX, Screen.height / 963f * 2.4f * unityScaleY, 1f);
        GameObject.Find("voice").transform.localScale = new Vector3(0f,0f,0f);
        GameObject.Find("ViviInput").transform.localScale = new Vector3(Screen.width / 1536f * 2f * unityScaleX, Screen.height / 963f * 2.15f * unityScaleY, 1f);
        GameObject.Find("ViviPortrait").transform.localScale = new Vector3(Screen.width / 320f * unityScaleX, Screen.height / 150f * unityScaleY, 1f);
        GameObject.Find("NPCPortrait").transform.localScale = new Vector3(Screen.width / 320f * unityScaleX, Screen.height / 150f * unityScaleY, 1f);
        GameObject.Find("DialogueBox").transform.localScale = new Vector3(Screen.width / 75f * unityScaleX, Screen.height / 180f * unityScaleY, 1f);
        GameObject.Find("Points").transform.localScale = new Vector3(Screen.width / 1536f *1.5f * unityScaleX, Screen.height / 963f* 1.5f * unityScaleY, 1f);
        GameObject.Find("New Spell").transform.localScale = new Vector3(Screen.width / 1536f * 1.5f * unityScaleX, Screen.height / 963f * 1.5f * unityScaleY, 1f);
        GameObject.Find("Title Scene").transform.localScale = new Vector3(Screen.width / 1536f * 1.5f * unityScaleX, Screen.height / 963f * 1.5f * unityScaleY, 1f);
        GameObject.Find("HistoryBubble").transform.localScale = new Vector3(Screen.width / 1536f * 4f * unityScaleX, Screen.height / 963f * 2.5f * unityScaleY, 1f);
        GameObject.Find("UIH1").transform.localScale = new Vector3(Screen.width / 1536f * .9375f * unityScaleX, Screen.height / 963f * 1.5f * unityScaleY, 1f);
        GameObject.Find("ViviKeyword_UI").transform.localScale = new Vector3(Screen.width / 1536f * 1.5f * unityScaleX, Screen.height / 963f * 1.5f * unityScaleY, 1f);
        GameObject.Find("UISpellManager").transform.localScale = new Vector3(Screen.width / 1536f * 1.2f * unityScaleX, Screen.height / 963f * 1.5f * unityScaleY, 1f);
        GameObject.Find("DiscoverSpells").transform.localScale = new Vector3(Screen.width / 1536f * 1.7f * unityScaleX, Screen.height / 963f * 1.7f * unityScaleY, 1f);
        GameObject.Find("UIIcon").transform.localScale = new Vector3(Screen.width / 1536f * 2.1f * unityScaleX, Screen.height / 963f * 2.625f * unityScaleY, 1f);
        GameObject.Find("UIIconMenu").transform.localScale = new Vector3(Screen.width / 1536f * 2.1f * unityScaleX, Screen.height / 963f * 2.625f * unityScaleY, 1f);
        GameObject.Find("Por_Back2").transform.localScale = new Vector3(Screen.width / 1536f * -24f * unityScaleX, Screen.height / 963f * 0f * unityScaleY, 1f);
        GameObject.Find("Por_Next2").transform.localScale = new Vector3(Screen.width / 1536f * 24f * unityScaleX, Screen.height / 963f * 0f * unityScaleY, 1f);
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (collision.tag == "Player")
        {
            ...
            {
                //Inkan: kill music when transtioning screens
            ...
            {
                //Inkan: kill music when transitioning screens
                GameObject.Find("Music Manager").GetComponent<MusicManager>().StartCoroutine("KillMusic");
                loading.text = "Loading...               ";
